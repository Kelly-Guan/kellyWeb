...
export default function Shad() {
    ...
    <body>
        ...
        <section class="expPage">
            <div id="h1"> <a href="https://www.instagram.com/market_angelo/" target="_blank" class="title-shad">Shad Fellow 2021</a></div> 
        </section>
        ...
        <section class="expPageDesc">
            <div class="expPageDescCont">
                <div class="expPageDescBox">
                    ...
                    <div id="text" class="info-section-Info">July 5th, 2021 - July 30th, 2021</div>
                </div>
                <div class="expPageDescBox">
                    <div id="h4" class="info-section-Title">Virtual Campus</div>
                    <div id="text" class="info-section-Info">University of Waterloo</div>
                </div>
                <div class="expPageDescBox">
                    <div id="h4" class="info-section-Title">Design Team Project</div>
                    <div id="text" class="info-section-Info">Grey(t)Water</div>
                </div>
            </div>
        </section>
