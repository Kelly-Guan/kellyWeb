    ...
    <div class="loader">
      {
        ...
        <section id="landing">
          <div id='landingCont'>
            <div id="landingText">
              <div id="h1">hey! i'm <p class="name anim-typewriter"><b>Kelly Guan</b>.</p></div>
            </div>
          </div>
        </section> 
        ...
        <section id="moi">
          <div id="moiCont">
            ...
            <div id="h3">
              ...
              i'm a 1st year Software Engineering student @uWaterloo, focusing my degree on <b>software</b> and <b>human-centric design</b>. 
              {/* <b> 1B student</b>,
              <b> varsity swimmer</b>, 
              <b> woman in stem</b>, 
              <b> adventurer</b> and 
